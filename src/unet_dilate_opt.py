...
Original file is located at
    https://colab.research.google.com/drive/1IbURmogby2arSDqcPZcaETpTkLtDn4sp
"""
...
def test_unet():
    ...
    model = UNetV2(in_channels=3)  # 3 channels for RGB, output channels automatically set
    preds = model(x)
